...
public class Step06ObjectOrientedTest extends PlainTestCase {
    ...
    public void test_objectOriented_aboutObject_againstObject() {
        ...
        // [final process]
        //
        saveBuyingHistory(quantity, salesProceeds, displayPrice, alreadyIn); //引数順番が間違っている by hieu 20/5
    }
    ...
    public void test_objectOriented_polymorphism_1st_concreteOnly() {
        ...
        log(land); // your answer? => 7. Cause by the dog have to breatheIn, prepareAbdominalMuscle and doBark
    }
    ...
    public void test_objectOriented_polymorphism_3rd_fromMethod() {
        Animal animal = createAnyAnimal(); // It's a Dog anyway
        BarkedSound sound = animal.bark();
        String sea = sound.getBarkWord();
        log(sea); // your answer? => wan
        int land = animal.getHitPoint();
    ...
    public void test_objectOriented_polymorphism_5rd_overrideWithSuper() {
        ...
        int land = animal.getHitPoint();
        log(land); // your answer? => 5. Cause by Cat's downHitPoint method is overriding Animal's downHitPoint method
    }
    ...
    public void test_objectOriented_polymorphism_interface_dispatch() {
        ...
        log(sea); // your answer? => vooo // imply called from Animal class implements Loudable interface
    ...
    public void test_objectOriented_polymorphism_interface_partImpl() {
        ...
        log(sea); // your answer? => true. Cat implements FastRunner
        boolean land = landAnimal instanceof FastRunner;
        log(land); // your answer? => false. Zombie slow as hell
    }
    ...
    public void test_objectOriented_polymorphism_makeConcrete() {
        Animal skyAnimal = new Raven();
        log("Is fast runner: {}", skyAnimal instanceof FastRunner);
        log("Is animal: {}", skyAnimal instanceof Animal);
        log("Let's bark: {}", skyAnimal.bark().getBarkWord());
    }
